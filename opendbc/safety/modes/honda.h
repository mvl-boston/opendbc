...
static safety_config honda_nidec_init(uint16_t param) {
  ...
  static CanMsg HONDA_N_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = false}, {0x194, 0, 4, .check_relay = false}, {0x1FA, 0, 8, .check_relay = false},
                                     {0x30C, 0, 8, .check_relay = false}, {0x33D, 0, 4, .check_relay = false}, {0x18DAF160, 0, 8, .check_relay = false}};
