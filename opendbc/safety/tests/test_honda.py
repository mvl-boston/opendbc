...
class TestHondaBoschCANFDLongSafety(HondaButtonEnableBase, TestHondaBoschCANFDSafetyBase):
  """
  ...
  TX_MSGS = [[0xE4, 0], [0x1DF, 0], [0x1EF, 0], [0x30C, 0], [0x33D, 0], [0x39F, 0], [0x18DAB0F1, 1]]
  ...
  def setUp(self):
    super().setUp()
    self.safety.set_safety_hooks(CarParams.SafetyModel.hondaBosch, HondaSafetyFlags.BOSCH_LONG | HondaSafetyFlags.BOSCH_CANFD)
    self.safety.init_tests()
