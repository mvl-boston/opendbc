...
_OPEN_BOSCH_A_CPS_SP = {car: CarInterface.get_non_essential_params_sp(_OPEN_BOSCH_A_CPS[car], car) for car in _OPEN_BOSCH_A_CARS}
...
def test_bosch_a_gate_open_to_other_bosch_a_platforms(car):
  ...
  cp_sp = _OPEN_BOSCH_A_CPS_SP[car]
  assert cp.radarUnavailable is False
