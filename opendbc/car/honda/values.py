...
class CAR(Platforms):
  ...
  ACURA_RLX_HYBRID = HondaNidecPlatformConfig(
    ...
    # force comment - rerun CI checks, again
    ...
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES | HondaFlags.NIDEC_HYBRID | HondaFlags.NIDEC_ALT_PCM_ACCEL | HondaFlags.ALT_STEER,
  )
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.eps: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_2022, CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.ACURA_MDX_3G_HYBRID, CAR.ACURA_RLX_HYBRID],
    Ecu.vsa: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_2022, CAR.HONDA_CRV_5G, CAR.HONDA_CRV_HYBRID,
              CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.HONDA_INSIGHT, CAR.ACURA_RLX_HYBRID],
  },
  extra_ecus=[
...
HONDA_ALT_STEER = CAR.with_flags(HondaFlags.ALT_STEER)
