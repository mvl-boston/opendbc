...
class CAR(Platforms):
  ...
  ACURA_MDX_3G_HYBRID = HondaNidecPlatformConfig(
    ...
    flags=HondaFlags.NIDEC_ALT_SCM_MESSAGES | HondaFlags.NIDEC_HYBRID | HondaFlags.NIDEC_ALT_PCM_ACCEL | HondaFlags.NIDEC_SERIAL_STEERING,
  )
...
HONDA_NIDEC_SERIAL_STEERING = CAR.with_flags(HondaFlags.NIDEC_SERIAL_STEERING)
