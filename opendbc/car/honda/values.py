...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.eps: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_2022, CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.ACURA_MDX_3G_HYBRID, CAR.ACURA_RLX_HYBRID], # REMOVERLX
    Ecu.vsa: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_2022, CAR.HONDA_CRV_5G, CAR.HONDA_CRV_HYBRID,
              CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.HONDA_INSIGHT, CAR.ACURA_MDX_3G_HYBRID, CAR.ACURA_RLX_HYBRID],
  },
  extra_ecus=[
...
STEER_THRESHOLD = {
  ...
  CAR.ACURA_RLX_HYBRID: 30, # try higher number  REMOVERLX
}
...
SERIAL_STEERING = {CAR.ACURA_RLX_HYBRID, CAR.ACURA_MDX_3G_HYBRID}
