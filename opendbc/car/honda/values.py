...
class CAR(Platforms):
  ...
  ACURA_RDX_3G_MMR = HondaBoschPlatformConfig(
    [HondaCarDocs("Acura RDX 2022", "All")],
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.eps: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_2022, CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.ACURA_INTEGRA, CAR.HONDA_ODYSSEY_5G_MMR, \
