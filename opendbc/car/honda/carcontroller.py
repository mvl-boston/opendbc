...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if (not self.CP.openpilotLongitudinalControl) or (self.CP.carFingerprint in HONDA_BOSCH_ALT_RADAR):
    ...
    if self.frame % 10 == 0:
      hud = HUDData(int(pcm_accel), int(round(hud_v_cruise)), hud_control.leadVisible,
                    hud_control.lanesVisible and CS.show_lanelines, fcw_display, acc_alert, steer_required, hud_control.leadDistanceBars)
