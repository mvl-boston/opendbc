...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if not self.CP.openpilotLongitudinalControl:
      ...
      if pcm_cancel_cmd and self.CP.carFingerprint not in HONDA_CANFD_CAR: # canFD buttons blocked awaiting PR 998
        can_sends.append(hondacan.spam_buttons_command(self.packer, self.CAN, CruiseButtons.CANCEL, self.CP.carFingerprint))
      elif CC.cruiseControl.resume and self.CP.carFingerprint not in HONDA_CANFD_CAR: # canFD buttons blocked awaiting PR 998
