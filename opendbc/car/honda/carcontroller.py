...
MAX_STEER_RATE = 39  # deg/s, LKA angle-rate limit for avoiding EPS faults
...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    apply_steer_req = CC.latActive and not abs(CS.out.steeringRateDeg) >= MAX_STEER_RATE and not CS.steer_blocked_prev
    ...
    can_sends.append(hondacan.create_steering_control(self.packer, self.CAN, apply_torque, apply_steer_req, self.CP.carFingerprint,
                                                      CS.steer_control_passthrough))
