...
from opendbc.car.honda.values import (CAR, HondaFlags, HONDA_BOSCH, HONDA_BOSCH_RADARLESS,
...
def create_lkas_hud(packer, bus, CP, hud_control, lat_active, steering_available, reduced_steering, alert_steer_required, lkas_hud, steer_max):
  commands = []
  ...
  lkas_hud_values = {
    ...
    'SOLID_LANES': hud_control.lanesVisible and not steer_max,
  ...
  if CP.carFingerprint in HONDA_BOSCH: # - try all Bosch, didn't work on Nidec
