...
def create_ui_commands(packer, CAN, CP, enabled, pcm_speed, hud, is_metric, acc_hud, lkas_hud, show_dashed_lines, speed_control):
  commands = []
  ...
  lkas_hud_values = {
    ...
    'SOLID_LANES': hud.lanes_visible and not show_dashed_lines,
