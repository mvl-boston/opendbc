...
non_tested_cars = [
  ...
  HONDA.HONDA_CITY_7G,
  HONDA.HONDA_ODYSSEY_5G_MMR,
  HONDA.ACURA_RDX_3G_MMR,
  HONDA.HONDA_ACCORD_11G,
  HONDA.ACURA_INTEGRA,
]
...
routes = [
  ...
  # CarTestRoute("d7233a428eb7d0b5/00000001--9b99b04d43", HONDA.HONDA_ODYSSEY_5G_MMR), # Azure route bug
  ...
  # CarTestRoute("f39cf149898833ff/0000002b--54f3fae045", HONDA.HONDA_ACCORD_11G), # Azure route bug
