...
#    self.p.set_safety_mode(CarParams.SafetyModel.silent, 2)
    self.CI = get_car(self._can_recv, self.p.can_send_many, self.p.set_obd, True) # removing last false that is in stock
